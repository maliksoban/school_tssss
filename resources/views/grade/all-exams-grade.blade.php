                    ...
                    @foreach($classes as $class)
                        <div class="panel panel-default">
                            ...
                            <a class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse{{$class->id}}" aria-expanded="false" aria-controls="collapse{{$class->id}}">
                                <h5>
                                {{$class->class_number}} {{$class->group}} <span class="pull-right fa fa-arrow-down"><b>@lang('Click to view all Sections under this Class')</b></span>
                                </h5>
                            </a>
                            </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @foreach($sections as $section)
                                                ...
                                                <td>
                                                    <a href="{{url('section/students/'.$section->id)}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> @lang('View Each Student\'s Grade History')</a>
                                                </td>
                                                <td>
                                                    <a href="{{url('grades/section/'.$section->id)}}" role="button" class="btn btn-xs btn-danger"><i class="fa fa-eye"></i> @lang('View all Students Marks under this Section')</a>
                                                </td>
                                                </tr>
                                                @endif
                                            @endforeach
