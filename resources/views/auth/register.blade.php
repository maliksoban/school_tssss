        ...
        <div class="col-md-3" id="side-navbar">
            <ul class="nav flex-column">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('schools.index') }}"><i class="fa fa-backward"></i> <span class="nav-link-text">@lang('Back to Manage School')</span></a>
                </li>
            </ul>
        </div>
        @endif
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="registerForm" action="{{ url('register/'.session('register_role')) }}">
                        ...
                        <div class="form-group{{ $errors->has('tsss_id') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">* @lang('School ID Card Number')</label>

                            <div class="col-md-6">
                                <input id="tssss_id" type="text" class="form-control" name="tssss_id" value="{{ old('tssss_id') }}"
                                       required>

                                @if ($errors->has('tssss_id'))
                                    <span class="help-block" style="color: red">
                                    <strong>{{ $errors->first('tssss_id') }}</strong>
                                </span>
                                @endif
                            </div>
                        </div>
