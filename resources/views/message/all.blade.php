                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-object">
                                            ...
                                            @else
                                                ...
                                                <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/male.png')}}" style="border-radius: 50%;" width="50px" height="50px">
                                                @else
                                                <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/female3.jpg')}}" style="border-radius: 50%;" width="50px" height="50px">
                                                @endif
                                            @endif
                                        </div>
                                        </div>
