  ...
  <div class="col-md-2">
    ...
    @else
      @if(strtolower($user->gender) == trans('male'))
        <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/boy.png')}}" class="img-thumbnail" width="100%">
      @else
        <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/girl.png')}}" class="img-thumbnail" width="100%">
      @endif
    @endif
  ...
  <div class="col-md-10" id="main-container">
    <h3>{{$user->name}} <span class="label label-danger">{{ucfirst($user->role)}}</span> <span class="label label-primary">{{ucfirst($user->gender)}}</span>
      ...
      @if($user->role == "student")
       <button class="btn btn-xs btn-success pull-right" role="button" id="btnPrint"><i class="fa fa-print"></i> @lang('Print Profile')</button>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="col-xs-3">
              ...
              @else
              @if(strtolower($user->gender) == trans('male'))
                <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/boy.png')}}" class="img-thumbnail" id="my-profile" alt="@lang('Profile Picture')" width="120px" height="120px">
              @else
                <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/girl.png')}}" class="img-thumbnail" id="my-profile" alt="@lang('Profile Picture')" width="120px" height="120px">
              @endif
              @endif
            </div>
          </div>
