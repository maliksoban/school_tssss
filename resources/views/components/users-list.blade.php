        ...
        <small>
          ...
          @else
            @if(strtolower($user->gender) == trans('male'))
              <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/boy.png')}}" style="border-radius: 50%;" width="25px" height="25px">&nbsp;
            @else
              <img src="{{asset('01-progress.gif')}}" data-src="{{url('images/girl.png')}}" style="border-radius: 50%;" width="25px" height="25px">&nbsp;
            @endif
          @endif
            @if(Auth::user()->role == 'admin')
