<div id="my_upload">
    ...
    <input class="form-control-sm" id="fileupload" type="file"
           accept="video/quicktime,video/mpeg,video/mp4,.xlsx,.xls,vnd.openxmlformats-officedocument.wordprocessingml.document,.vnd.ms-powerpoint,.doc,.docx,.ppt,.pptx,.txt,.pdf,image/png,image/jpeg"
           name="file" data-url="{{url('upload/file')}}">
    <br/>
    <div class="progress">
        ...
        var uploadButton = $('<button/>')
            ...
            .on('click', function () {
                ...
                var $this = $(this),
                    data = $this.data();
                $('#fileupload').hide();
                var acceptFileTypes = /application\/(vnd.openxmlformats-officedocument.wordprocessingml.document|vnd.ms-powerpoint|mp4|pdf|xlsx|xls|doc|docx|ppt|pptx|txt)|video\/(mp4|mpeg|quicktime)|image\/(png|jpeg)$/i;
        ...
        $('#fileupload').fileupload({
            ...
            .on('fileuploaddone', function (e, data) {
                ...
                if(error) {
                    ...
                    data.context.html('<div>' + @json( __('Uploaded Successfully.')) + '</div>');
