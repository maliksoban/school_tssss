                    ...
                    <div class="panel-body table-responsive">
                        <table class="table table-condensed">
                            <thead>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#departmentModal"><i class="fa fa-plus-circle"></i> @lang('Create Department')</button>
                                        <!-- Modal -->
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" action="{{url('school/add-department')}}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="department_name" name="department_name" placeholder="@lang('Pre-School, Junior Section,...')">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                    ...
                                    <td>
                                        <a href="#collapse" role="button" class="btn btn-danger btn-sm" data-toggle="collapse" aria-expanded="false" aria-controls="collapse">
                                            <i class="fa fa-plus-circle"></i> @lang('Manage Class, Section')
                                        </a>
                                    </td>
                                </tr>
                                        ...
                                        <div class="row">
                                            @foreach($classes as $class)
                                                @if($class->school_id == $school->id)
                                                    <div class="col-sm-3">
                                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal{{$class->id}}" style="margin-top: 5%;"><i class="fa fa-magic"></i>@lang('Manage') {{$class->class_number}} {{!empty($class->group)? '- '.$class->group:''}}</button>
                                                        <!-- Modal -->
                                ...
                                <tr>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{ url('academic/notice') }}">
                                            <i class="fa fa-upload"></i> @lang('Upload Notice')
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{ url('academic/event') }}">
                                            <i class="fa fa-upload"></i> @lang('Upload Event')
                                        </a>
                                    </td>
                                </tr>
                            </tbody>
