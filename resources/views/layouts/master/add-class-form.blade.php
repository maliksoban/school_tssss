<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addClassModal{{$school->id}}">
    <i class="fa fa-plus-circle"></i>@lang('Add New Class')</button>
...
{{--          </div>--}}
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" name="group" id="classRoomNumber{{$school->id}}" placeholder="@lang('Science, Arts, etc.')">
